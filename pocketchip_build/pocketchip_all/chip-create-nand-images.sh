...
#
# based: https://github.com/NextThingCo/CHIP-tools/blob/chip/stable/chip-create-nand-images.sh
#
...
#
# UBOOTDIR = /test/tmp/pocketchip_uboot/CHIP-u-boot-production-mlc
# ROOTFSTAR = /test/tmp/pocketchip_buildroot/CHIP-buildroot-chip-stable/output/images/rootfs.tar
# OUTPUTDIR = ./output/
#
...
prepare_ubi() {
  echo "===================="
  echo "DO NOT USE THIS UBI"
  echo "USE THIS:"
  echo "# for Toshiba_4G_MLC"
  echo "# chip-400000-4000-500.ubi.sparse (UBI sparse)"
  echo "# - http://opensource.nextthing.co/chip/images/stable/pocketchip/126/chip-400000-4000-500.ubi.sparse"
  echo "===================="
  echo
